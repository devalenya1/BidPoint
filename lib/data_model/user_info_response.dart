...
class UserInformation {
  ...
  Map<String, dynamic> toJson() => {
    ...
    "affiliate_logs": List<dynamic>.from(affiliateLogs!.map((x) => x.toJson())),
    "total_affiliate_earnings": totalAffiliateEarnings,
    "affiliate_withdraw_requests": List<dynamic>.from(affiliateWithdrawRequests!.map((x) => x.toJson())),
    ...
    "customer_package_payments": List<dynamic>.from(customerPackagePayments!.map((x) => x.toJson())),
    "total_package_payments": totalPackagePayments,
    "wishlist": List<dynamic>.from(wishlist!.map((x) => x.toJson())),
    "wishlist_count": wishlistCount,
    "auction_bids": List<dynamic>.from(auctionBids!.map((x) => x.toJson())),
    "auction_bids_count": auctionBidsCount,
    "distinct_auction_bids": List<dynamic>.from(distinctAuctionBids!.map((x) => x.toJson())),
