              ...
              child: MasonryGridView.count(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ProductCard(
                    ...
                    currentBid: double.tryParse(productResponse.products![index].highestBid?.toString() ?? '0'),
                    startingBid: double.tryParse(productResponse.products![index].startingBid?.toString() ?? '0'),
